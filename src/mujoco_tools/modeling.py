...
def sample_manipulator(spec):
    ...
    link0.add_joint(name="joint0", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 0, 1], range=[-90, 90]) # joint range unit is [degree]
    # link1
    link1 = link0.add_body(name="link1", mass=0.3, inertia=[4e-4, 4e-4, 4e-4])
    link1.add_joint(name="joint1", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    # link2
    link2 = link1.add_body(name="link2", mass=0.2, inertia=[2e-4, 2e-4, 2e-4])
    link2.add_joint(name="joint2", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    link2.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, fromto=[0,0,0.05, 0,0,0.3], size=[0.02, 0.0, 0.0], rgba=red)
    # link3
    link3 = link2.add_body(name="link3", mass=0.2, inertia=[2e-4, 2e-4, 2e-4], pos = [0, 0, 0.3])
    link3.add_joint(name="joint3", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    link3.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, fromto=[0,0,0.05, 0,0,0.3], size=[0.02, 0.0, 0.0], rgba=green)
    # link4
    link4 = link3.add_body(name="link4", mass=0.1, inertia=[1e-4, 1e-4, 1e-4], pos=[0, 0, 0.3])
    link4.add_joint(name="joint4", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 0, 1], range=[-90, 90])
    # link5
    link5 = link4.add_body(name="link5", mass=0.1, inertia=[1e-4, 1e-4, 1e-4])
    link5.add_joint(name="joint5", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    # link6
    link6 = link5.add_body(name="link6", mass=0.1, inertia=[1e-4, 1e-4, 1e-4])
    link6.add_joint(name="joint6", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    link6.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, fromto=[0,0,0.05, 0,0,0.1], size=[0.02, 0.0, 0.0], rgba=blue)
    # end effector
...
def sample_robot_biped(spec):
    ...
    rleg_link0.add_joint(name="rleg_joint0", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 0, 1], range=[-90, 90])
    # rleg_link1
    rleg_link1 = rleg_link0.add_body(name="rleg_link1", mass=0.3, inertia=[4e-4, 4e-4, 4e-4])
    rleg_link1.add_joint(name="rleg_joint1", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    # rleg_link2
    rleg_link2 = rleg_link1.add_body(name="rleg_link2", mass=0.2, inertia=[2e-4, 2e-4, 2e-4])
    rleg_link2.add_joint(name="rleg_joint2", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    ...
    rleg_link3.add_joint(name="rleg_joint3", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    ...
    rleg_link4.add_joint(name="rleg_joint4", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    # rleg_link5
    rleg_link5 = rleg_link4.add_body(name="rleg_link5", mass=0.1, inertia=[1e-4, 1e-4, 1e-4])
    rleg_link5.add_joint(name="rleg_joint5", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    ...
    lleg_link0.add_joint(name="lleg_joint0", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 0, 1], range=[-90, 90])
    # lleg_link1
    lleg_link1 = lleg_link0.add_body(name="lleg_link1", mass=0.3, inertia=[4e-4, 4e-4, 4e-4])
    lleg_link1.add_joint(name="lleg_joint1", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    # lleg_link2
    lleg_link2 = lleg_link1.add_body(name="lleg_link2", mass=0.2, inertia=[2e-4, 2e-4, 2e-4])
    lleg_link2.add_joint(name="lleg_joint2", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    ...
    lleg_link3.add_joint(name="lleg_joint3", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    ...
    lleg_link4.add_joint(name="lleg_joint4", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    # lleg_link5
    lleg_link5 = lleg_link4.add_body(name="lleg_link5", mass=0.1, inertia=[1e-4, 1e-4, 1e-4])
    lleg_link5.add_joint(name="lleg_joint5", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
