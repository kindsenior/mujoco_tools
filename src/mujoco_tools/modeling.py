...
def sample_robot_biped(spec, *, prefix=None, free_joint=True, contype=1, conaffinity=1):
    ...
    if free_joint:
        free_joint = base.add_freejoint() # add a free joint
        free_joint.name = f"{prefix}root"
    base.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=3.0, size=[0.05, 0.05, 0.02], rgba=gray, contype=contype, conaffinity=conaffinity)
    ...
    # rleg_link2
    rleg_link2 = rleg_link1.add_body(name=f"{prefix}rleg_link2")
    rleg_link2.add_joint(name=f"{prefix}rleg_joint2", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    rleg_link2.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.2, fromto=[0,0,0, 0,0,-0.20], size=[0.02, 0.0, 0.0], rgba=red, contype=contype, conaffinity=conaffinity)
    # rleg_link3
    rleg_link3 = rleg_link2.add_body(name=f"{prefix}rleg_link3", pos = [0, 0, -0.25])
    rleg_link3.add_joint(name=f"{prefix}rleg_joint3", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    rleg_link3.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.2, fromto=[0,0,0, 0,0,-0.20], size=[0.02, 0.0, 0.0], rgba=green, contype=contype, conaffinity=conaffinity)
    # rleg_link4
    ...
    # rleg_link5
    rleg_link5 = rleg_link4.add_body(name=f"{prefix}rleg_link5")
    rleg_link5.add_joint(name=f"{prefix}rleg_joint5", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    rleg_link5.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.1, fromto=[0,0,0, 0.1,0,0], size=[0.02, 0.0, 0.0], rgba=blue)
    # right end effector
    ...
    # lleg_link2
    lleg_link2 = lleg_link1.add_body(name=f"{prefix}lleg_link2")
    lleg_link2.add_joint(name=f"{prefix}lleg_joint2", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    lleg_link2.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.2, fromto=[0,0,0, 0,0,-0.20], size=[0.02, 0.0, 0.0], rgba=red, contype=contype, conaffinity=conaffinity)
    # lleg_link3
    lleg_link3 = lleg_link2.add_body(name=f"{prefix}lleg_link3", pos = [0, 0, -0.25])
    lleg_link3.add_joint(name=f"{prefix}lleg_joint3", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[0, 1, 0], range=[-90, 90])
    lleg_link3.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.2, fromto=[0,0,0, 0,0,-0.20], size=[0.02, 0.0, 0.0], rgba=green, contype=contype, conaffinity=conaffinity)
    # lleg_link4
    ...
    # lleg_link5
    lleg_link5 = lleg_link4.add_body(name=f"{prefix}lleg_link5")
    lleg_link5.add_joint(name=f"{prefix}lleg_joint5", type=mujoco.mjtJoint.mjJNT_HINGE, axis=[1, 0, 0], range=[-90, 90])
    lleg_link5.add_geom(type=mujoco.mjtGeom.mjGEOM_BOX, mass=0.1, fromto=[0,0,0, 0.1,0,0], size=[0.02, 0.0, 0.0], rgba=blue, contype=contype, conaffinity=conaffinity)
    # left end effector
